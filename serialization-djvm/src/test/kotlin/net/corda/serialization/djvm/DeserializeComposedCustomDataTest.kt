...
class DeserializeComposedCustomDataTest: TestBase(KOTLIN) {
    ...
    @RegisterExtension
    @JvmField
    val serialization = LocalSerialization(setOf(StringAtomSerializer(), LongAtomSerializer()))
    ...
    fun `test deserializing composed object`() {
        ...
        sandbox {
            ...
            _contextSerializationEnv.set(createSandboxSerializationEnv(classLoader, customSerializers))
